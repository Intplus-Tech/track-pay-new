...
const branchData = [
  { id: "LN-8589", location: "HQ", manager: "Adeola Bello", activeLoans: 1242, status: "Active", enabled: true },
  { id: "LN-1908", location: "Lagos Main", manager: "Chike Obi", activeLoans: 872, status: "Active", enabled: true },
  { id: "LN-1933", location: "Abuja", manager: "Fatima Yusuf", activeLoans: 23, status: "Active", enabled: true },
  { id: "LN-1898", location: "Lekki", manager: "Emeka Okoro", activeLoans: 87, status: "Close", enabled: false },
]
